...
using Architecture.Data.Configurations;
...
{
     public class ArchitectureDbContext :IdentityDbContext<ApplicationUser>,IDbContext
    {
        ...
        : base("AjsAppDbConnection")
        {

        }

        public ArchitectureDbContext(string nameOrConnectionString, ILogger logger)
        ...
        public static ArchitectureDbContext Create()
        {
            return new ArchitectureDbContext(nameOrConnectionString: "AjsAppDbConnection", logger: null);
        }
